...
! function(a) {
    function c(a, b) {
        return a >= b ? c(a - b, b) : a < 0 ? c(a + b, b) : a
    }

    function d(a) {
        for (var e, d = a.data(b), f = 0; f < 200; f++)
            if (!d.content[f]) {
                e = f;
                break
            }
        d.nextItem = c(d.nextItem || 0, e), d.currentItem = d.nextItem, d.elemIndex = [d.currentItem], d.charIndex = 0, d.nextItem++
    }
    ...
    function e(b) {
        var c = {
            ...
            d = b.children();
        return d.length ? (d.each(function(b) {
            c[b] = e(a(this))
        }), c) : (c.text = b.text(), c)
    }
    ...
    function f(b, c) {
        var d;
        return !!b[c[0]] && (b[c[0]].text ? b[c[0]] : 1 == c.length || (d = a.makeArray(c), f(b[d[0]], d.splice(1, d.length))))
    }
    ...
    function h(a, b) {
        if (!1 === b) return !1;
        var c = f(a, b);
        return !1 === c ? h(a, g(b.slice(0, b.length - 1))) : !0 === c ? (b[b.length] = 0, h(a, b)) : b
    }

    function i(b, c, d, e) {
        var f, g, h = b.children().eq(d[0]);
        return d.length ? (g = h.length ? h : c[d[0]].elem.appendTo(b), f = a.makeArray(d).slice(1, d.length), i(g, c[d[0]], f, e)) : {
            readout: b,
            text: c.text
        }
    }
    ...
    function j(c) {
        var d = c.data(b);
        a("*", c).empty(), c.empty(), d.start = 0, d.sum = 0, d.cursorIndex && (cursorIndex = 0)
    }
    ...
    function l(a, b, d) {
        var e, f;
        return !1 !== d.cursorIndex ? (d.cursorIndex = c(d.cursorIndex + 1, d.cursorList.length), d.cursor.html(d.cursorList[d.cursorIndex])) : d.cursor.html(d.cursorList), e = d.charIndex - d.start, f = d.text.charAt(e - 1), d.cursor.before(f), d.charIndex >= d.sum ? (d.cursor.remove(), d.elemIndex = g(d.elemIndex), m(a, b)) : setTimeout(function() {
            d.eventIndex == b && (d.charIndex++, l(a, b, d)), b = null
        }, d.rate)
    }

    function m(c, e) {
        var f = c.data(b);
        if (f.eventIndex == e) return f.elemIndex = h(f.content, f.elemIndex), !1 === f.elemIndex ? setTimeout(function() {
            if (f.running && f.eventIndex == e) return d(c), m(c, e);
            e = null
        }, f.delay) : (f.charIndex ? k(c) : j(c), a.extend(f, i(c, f.content, f.elemIndex)), f.sum = f.sum + f.text.length, f.readout.append(f.cursor), l(c, e, f))
    }
    var b = "ticker";
    a.fn[b] = function(c) {
        var f = a.extend({}, a.fn.ticker.defaults, c);
        return this.each(function() {
            var c = a(this);
            c.data(b, {
                rate: f.rate,
                ...
                content: e(c),
                cursor: f.cursor,
                cursorList: f.cursorList,
                cursorIndex: "object" == typeof f.cursorList && 0,
                nextItem: 0,
                eventIndex: 0
            }).bind("stop", function(a) {
                c.data(b).running = !1
            }).bind("play", function(a) {
                var e = c.data(b);
                e.eventIndex++, e.running = !0, e.nextItem = a.item || e.nextItem, d(c), m(c, e.eventIndex)
            }).bind("control", function(d) {
                var e = c.data(b);
                a().extend(e, {
                    nextItem: d.item,
                    rate: d.rate,
